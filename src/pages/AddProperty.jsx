        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setFormData(prev => ({ ...prev, square_ft: e.target.value }))}
          ...
          <div>
            <label className="block text-sm font-medium mb-2">Assistant Manager</label>
            <input
              type="text"
              value={formData.assistant_manager}
              onChange={(e) => setFormData(prev => ({ ...prev, assistant_manager: e.target.value }))}
          ...
          <div>
            <label className="block text-sm font-medium mb-2">Local Fire Brigade</label>
            <input
              type="text"
              value={formData.local_fire_brigade}
              onChange={(e) => setFormData(prev => ({ ...prev, local_fire_brigade: e.target.value }))}
          ...
          <div>
            <label className="block text-sm font-medium mb-2">Fire Strategy</label>
            <textarea
              value={formData.fire_strategy}
              onChange={(e) => setFormData(prev => ({ ...prev, fire_strategy: e.target.value }))}
          ...
          <div>
            <label className="block text-sm font-medium mb-2">Evacuation Policy</label>
            <textarea
              value={formData.evacuation_policy}
              onChange={(e) => setFormData(prev => ({ ...prev, evacuation_policy: e.target.value }))}
          ...
          <div>
            <label className="block text-sm font-medium mb-2">Contractor Hours</label>
            <input
              type="text"
              value={formData.contactor_hours}
              onChange={(e) => setFormData(prev => ({ ...prev, contactor_hours: e.target.value }))}
