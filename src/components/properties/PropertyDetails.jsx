          ...
          {activeTab === "overview" && (
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8">
                <div>
                  <h3 className="text-sm font-medium text-primary-grey mb-4">
              ...
              <div>
                ...
                <div className="bg-white rounded-lg border border-grey-outline overflow-hidden">
                  ...
                  {protectionAssets.map((asset, index) => (
                    <div
                      key={index}
                      className="grid grid-cols-3 gap-4 p-4 border-b border-grey-outline last:border-0"
                    >
